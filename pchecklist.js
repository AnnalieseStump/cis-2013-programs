...
var passwordCheckOld = function () 
{
    ...
    stringOutput = "";
            ...
            for (a=0; a<arrayBadPasswords.length; a++)
            {
                if (stringPassword==arrayBadPasswords[a] || stringPassword.length < 8)
                {
                ...
                {
                    stringOutput="That is likely a strong password! It should be safe to use :)";
                }
            }
