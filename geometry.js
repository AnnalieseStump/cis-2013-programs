...
//lines 12-18 declares and sets variables with respective DOM input. lines 19-25 declare variables needed for calculations
	...
	" and the perimeter is " + rectanglePerim(floatRectWidth, floatRectHeight) +
	"\n\n" + "The Triangle area is " + triangleArea(floatTriSide1, floatTriSide2, floatTriSide3) +
	" and the perimeter is " + trianglePerim(floatTriSide1, floatTriSide2, floatTriSide3) + "\n\n" +
...
function rectangleArea(floatRectWidth_par, floatRectHeight_par)
{
...
function rectanglePerim(floatRectWidth_par, floatRectHeight_par)
{
...
//    $("radius").value = "";
    ...
    $("calc_circle_area").onclick = calcCircleArea; //calling back the area of the circle
    $("calc_tri_area").onclick = calcTriangleArea;
	$("calc_tri_perim").onclick = calcTrianglePerimeter;
